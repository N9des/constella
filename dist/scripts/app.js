...
gsap_Draggable__WEBPACK_IMPORTED_MODULE_1__["Draggable"].create(".svg", {
  type: "x,y",
  bounds: ".container",
  inertia: true
});
...
var activeArea = function activeArea(id) {
  ...
  var constSize = rawData[3];
  var constClass = rawData[4];
  var constDeclin = rawData[5];
  var constMeaning = rawData[6];
  var constStars = rawData[7];
  var constComment = rawData[8];
  var constInfo = rawData[9];
  var constNum = rawData[10];
